...
public:
	...
	std::vector<std::tuple<Scopes, BuiltinFunctionForEVM>> const& functions() const { return m_functions; }
...
private:
	...
	std::vector<std::tuple<Scopes, BuiltinFunctionForEVM>> m_functions;
};
