...
template<typename T>
concept ToStringView = std::is_convertible_v<T, std::string_view>;
...
public:
	...
	template<ToStringView T>
	ContractName(T const& _name): ContractName(std::string_view{_name}) {}
...
public:
	...
	/// @param hash
	EventSignature const* matchEvent(util::h256 const& _hash) const;
